...
const PlaceOrder = () => {
  ...
  return (
    <form
      ...
      onSubmit={(e) => handleSubmit(e, "fullPayment")}
    >
      <div className="place-order-left">
        ...
        <div className="multi-fields">
          ...
          />
          {errors.firstName && (
            <span className="error" style={{ color: "darkred" }}>
              {errors.firstName}
            </span>
          )}
          <input
        ...
        <div className="cart-total">
          ...
          <div>
            <div className="cart-total-details">
              <p>
                Making Charges (10%) : Rs.{" "}
                {cartAmount === 0 ? 0 : makingCharges.toFixed(2)}
              </p>
            </div>
            <div className="cart-total-details">
              <p>
                SGST @1.50% : Rs. {cartAmount === 0 ? 0 : sgst.toFixed(2)}
              </p>
            </div>
            <div className="cart-total-details">
              <p>
                CGST @1.50% : Rs. {cartAmount === 0 ? 0 : cgst.toFixed(2)}
              </p>
            </div>
            <hr /> <br />
            <div className="cart-total-details">
            ...
            <br />
            <Link to="/click-and-collect" className="click-collect-link">
